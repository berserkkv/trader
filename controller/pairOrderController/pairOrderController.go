...
func GetOrders(c *gin.Context) {
	orders := pairOrderService.GetAllOrders()
...
func GetOrderStatistics(c *gin.Context) {
	...
	if botIdParam == "" {
		statsMap := pairOrderService.GetAllOrderStatistics()
	...
	s := pairOrderService.GetOrderStatistics(botId)
...
func CreateOrder(c *gin.Context) {
	...
	newOrder := pairOrderService.CreateOrder(order)
...
func GetOrdersByBotId(c *gin.Context) {
	...
	orders := pairOrderService.GetOrdersByBotId(botId)
	c.JSON(200, orders)
}
