...
func GetAllBots(c *gin.Context) {
	...
	bots := pairBotService.GetAllBots(fields)
...
func GetBotById(c *gin.Context) {
	...
	b := pairBotService.GetBotById(id)
...
func StopBot(c *gin.Context) {
	...
	err := pairBotService.StopBot(int64(botId))
	if err != nil {
...
func ClosePosition(c *gin.Context) {
	...
	pairBotService.ClosePosition(int64(botId))
...
func StartBot(c *gin.Context) {
	...
	err := pairBotService.StartBot(botId)
	if err != nil {
...
func CreateBot(c *gin.Context) {
	...
	bot, err := pairBotService.CreateBot(req.Symbol, req.Strategy, req.Timeframe, req.Capital, req.Leverage, req.TakeProfit, req.StopLoss)
	if err != nil {
